...
import FloorView from '@/components/reservations/FloorView'
    ...
    <div>
      ...
      {tab === 'board' ? (
        <div className="live-seating-stack">
          <FloorView outletId={outletId} outlets={outlets} onOutletChange={setOutletId} />
